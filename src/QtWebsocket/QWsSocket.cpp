...
void QWsSocket::startHandshake()
{
    ...
    if (_version == WS_V13)
	{
        ...
        QString handshake = composeOpeningHandShakeV13(path, _host, key);
    ...
    else if (_version == WS_V0)
	{
        ...
        QString handshake = composeOpeningHandShakeV0(path, _host, key1, key2, key3);
		tcpSocket->write(handshake.toUtf8());
	}
